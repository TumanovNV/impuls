...
Impuls 1.2.4 includes a voluntary feedback window. The app prepares the report
...
- notification permission is not requested in Impuls 1.2.4 and remains reserved
